...
namespace Pw\Repository\Mediators;

use Illuminate\Contracts\Container\Container as Application;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;
use Pw\Repository\Repository;
use Pw\Repository\Services\CacheService;
use Pw\Repository\Services\CriteriaService;
use Pw\Repository\Services\DatabaseService;
use Pw\Repository\Services\TransformService;
 ...
 * @package   Pw\Repository\Mediators
 */
class RepositoryMediator
{
    /**
